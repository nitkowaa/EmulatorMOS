...
def TSX(): # wyciaga X z pamieci
    ...
    sp = sp + 1
    pageDown = pageDown + 1
def PHA(): # zapisuje akumulator w pamieci
    global akumulator
    global pamiec
    global sp
    global pageDown

    pamiec[pageDown] = akumulator
    sp = sp - 1
    pageDown = pageDown - 1

def PLA(): # wyciaga akumulator z pamieci
    global akumulator
    global pamiec
    global sp
    global pageDown

    akumulator = akumulator + pamiec[sp]
    sp = sp + 1
    pageDown = pageDown + 1

def PHP(): # zapisuje status procesor w pamieci
    global flagi
    global pamiec
    global pageDown
    valueDec = ""
...
def PLP(): # wyciaga status procesor z pamieci
    pass
# endregion
